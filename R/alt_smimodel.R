#' Sparse Multiple Index (SMI) models - Alternative function (trial for changes in algorithm) 
#'
...
#'
#' @export
alt_smimodel <- function(data, yvar, index.vars, index.ind = NULL, index.coefs = NULL, 
