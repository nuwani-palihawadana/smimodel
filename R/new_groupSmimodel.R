#' Constructor function for the class `groupSmimodel`
#'
#' Constructs an object of class `groupsmimodel` (A tibble of Multiple
#' `smimodel`s fitted based on a grouping variable of interest.) using the
#' information passed to arguments.
#'
