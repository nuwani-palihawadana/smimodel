...
Here we present a simple example to illustrate *smimodel* functionalities. Here, we use randomly simualted data (if we treat as time series data for the purpose of this illustration). 
...
#>  6    11 1         1 -0.145     3.70 
#>  7    12 1         1  0.200     2.16 
#>  8    13 1         1 -0.00571   2.20 
#>  9    14 1         1 -0.0585    2.78 
#> 10    15 1         1  0.0690    0.588
#> # ℹ 1,190 more rows
```
...
preds$.predict
#>          1          2          3          4          5          6          7          8          9 
#> 3.45875360 1.52227919 0.52880855 2.24035447 1.12107276 1.37713767 3.45942517 1.29280192 1.30480566 
#>         10         11         12         13         14         15         16         17         18 
#> 0.76693545 0.94033488 1.69198431 1.19066249 1.31326875 1.62227824 2.32393383 0.83445397 1.04509061 
#>         19         20         21         22         23         24         25         26         27 
#> 1.18655312 4.77834694 0.61093744 1.14584732 0.79738221 1.40808532 2.33526421 0.17577374 0.55496899 
#>         28         29         30         31         32         33         34         35         36 
#> 0.36529866 0.86681103 0.58204856 0.07682007 0.12715529 0.59371216 2.34226385 0.88236558 0.31311111 
#>         37         38         39         40         41         42         43         44         45 
#> 0.47272659 0.98720165 1.08509888 1.63224918 1.08438509 0.94669085 0.69782353 0.29352741 1.42720628 
#>         46         47         48         49         50         51         52         53         54 
#> 1.80572247 1.56637510 1.60908432 0.46992393 0.52987060 1.75371871 0.35670649 0.52323692 2.84421127 
#>         55         56         57         58         59         60         61         62         63 
#> 1.52535370 1.21156948 1.57453981 0.35167620 0.81628405 1.16983886 0.14744511 0.76252582 3.59290975 
#>         64         65         66         67         68         69         70         71         72 
#> 0.41181343 2.45049698 1.07340762 0.95589245 2.55009128 0.60641399 3.72815766 1.90521879 2.62652981 
#>         73         74         75         76         77         78         79         80         81 
#> 2.97443699 1.17261772 1.32266211 0.58847321 1.53256348 2.14620453 1.74196033 2.66079722 0.79429558 
#>         82         83         84         85         86         87         88         89         90 
#> 2.20897903 1.95718530 1.04773348 1.37572151 2.27213126 1.86737719 0.84856383 2.17397781 1.42471564 
#>         91         92         93         94         95         96         97         98         99 
#> 0.92667083 2.26161184 2.21898525 3.09128299 2.79446901 0.60598830 1.10399832 1.38587758 1.84832912 
#>        100        101        102        103        104        105        106        107        108 
#> 2.95928555 1.75660511 0.83714430 0.44663934 1.24111245 0.44727364 0.43799518 0.43482004 1.11403817 
#>        109        110        111        112        113        114        115        116        117 
#> 0.90800044 0.98409269 0.77391472 0.92785702 1.44316952 0.53590864 0.70992557 0.71795367 1.41767627 
#>        118        119        120        121        122        123        124        125        126 
#> 1.35755171 2.13572864 2.08429255 2.88077403 0.93061265 2.19668448 0.26132385 1.22310614 1.28597984 
#>        127        128        129        130        131        132        133        134        135 
#> 0.54794128 1.30397022 1.46473967 1.18312432 0.66352089 1.22851354 2.41435774 2.60599648 2.59238828 
#>        136        137        138        139        140        141        142        143        144 
#> 0.97740626 1.39710783 1.03604564 0.73902124 1.11037224 2.98249799 1.16391896 1.56621292 2.29963466 
#>        145        146        147        148        149        150        151        152        153 
#> 1.45009184 1.01222554 0.19617271 0.24803399 0.17703256 0.24552563 0.11939212 0.06335220 0.78697613 
#>        154        155        156        157        158        159        160        161        162 
#> 0.77510635 0.44432453 2.11483538 0.36391256 1.84129138 1.72201990 0.56247370 0.86526847 0.15402016 
#>        163        164        165        166        167        168        169        170        171 
#> 0.86083936 0.36209757 0.16949933 0.38394420 0.08913008 0.44101062 0.88294700 1.29236403 2.58720561 
#>        172        173        174        175        176        177        178        179        180 
#> 1.48371584 3.04050271 1.20272894 1.04586471 2.14226311 0.44197911 2.79409966 0.52716184 1.55409408 
#>        181        182        183        184        185        186        187        188        189 
#> 1.42580958 0.36625918 2.72545338 0.29608417 0.87043117 2.92144727 1.94118426 1.64383054 1.23770969 
#>        190        191        192        193        194        195        196        197        198 
#> 0.96011465 2.37079749 2.37095011 1.44371539 0.58065812 0.37881156 0.50417540 0.34462665 0.18876375 
#>        199        200 
#> 0.20226411 0.26617415
```
...
Now, we have to provide a grid of values for the penalty parameters, and a set of starting points for the search, using  which the greedy search for a best parameter combination will be performed. 


```r
## Construct grid and starting points
...
# L0 penalty parameter starting points
lambda0_start = as.numeric(unique(unlist(starting[1])))
# L2 penalty parameter starting points
...
#> [1] "Loss increased for 3 consecutive iterations!"
#> [1] "Final model fitted!"
#> [1] "First round completed; starting point selected!"
#> [1] "Tolerance for loss reached!"
#> [1] "Tolerance for loss reached!"
#> [1] "Final model fitted!"
#> [1] "Loss increased for 3 consecutive iterations!"
...
Here the selected penalty parameter combination is $(\lambda_{0}, \lambda_{2}) = (1, 3)$. 
