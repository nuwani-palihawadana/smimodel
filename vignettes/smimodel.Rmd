...
Now, we have to provide a sequence of values for the penalty parameters.


``` r

# L0 penalty parameter
lambda0 = seq(0, 12, by = 1)
...
Here the selected penalty parameter combination is $(\lambda_{0}, \lambda_{2}) = (11, 5)$. 
